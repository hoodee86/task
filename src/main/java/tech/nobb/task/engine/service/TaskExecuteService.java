...
public class TaskExecuteService extends BaseService {
    ...
    public void suspendTask(SuspendTaskRequest suspendTaskRequest) {
        Task task = new Task(suspendTaskRequest.getTaskId(), taskRepository, executionRepository, configRepository);
        task.restore();
    ...
    public void unsuspendTask(UnsuspendTaskRequest unsuspendTaskRequest) {
        Task task = new Task(unsuspendTaskRequest.getTaskId(), taskRepository, executionRepository, configRepository);
        task.restore();
    ...
    public void forwardTask(ForwardTaskRequest forwardTaskRequest) {
        Task task = new Task(forwardTaskRequest.getTaskId(), taskRepository, executionRepository, configRepository);
        task.restore();
